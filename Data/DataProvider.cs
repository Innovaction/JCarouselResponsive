...
namespace DotNetNuke.Modules.JCarouselResponsive.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "DotNetNuke.Modules.JCarouselResponsive.Data.SqlDataprovider,JCarouselResponsive";
