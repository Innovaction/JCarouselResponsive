...
namespace DotNetNuke.Modules.JCarouselResponsive
{
    ...
    /// are accessible to your module's controls (that inherity from JCarouselResponsiveModuleBase
    /// 
    /// </summary>

    public class JCarouselResponsiveModuleBase : DotNetNuke.Entities.Modules.PortalModuleBase
    {
    }
}
