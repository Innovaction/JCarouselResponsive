...
namespace DotNetNuke.Modules.JCarouselResponsive
{
    ...
    /// are accessible to your module's controls (that inherity from JCarouselResponsiveSettingsBase
    /// 
    /// </summary>


    public class JCarouselResponsiveSettingsBase : ModuleSettingsBase
    {
